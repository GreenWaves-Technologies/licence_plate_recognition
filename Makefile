...
APP_CFLAGS += -O3
APP_CFLAGS += -I. -I$(MODEL_COMMON_INC) -I$(TILER_EMU_INC) -I$(TILER_INC) $(CNN_LIB_INCLUDE) -I$(TILER_BILINEAR_RESIZE_GENERATOR_PATH)

APP_SRCS += BUILD_MODEL_SSD/ssdlite_ocrKernels.c BUILD_MODEL_LPR/lprnetKernels.c $(TILER_BILINEAR_RESIZE_GENERATOR_PATH)/ResizeBasicKernels.c
