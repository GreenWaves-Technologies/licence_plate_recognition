...
void Generate_common_declarations(FILE * sf, FILE * hf){
	...
	fprintf(hf,"#ifndef SSDPARAMS\n");
	fprintf(hf,"#define SSDPARAMS\n");

	// a structure including bboxes info
	fprintf(hf,"typedef struct{\n");
	fprintf(hf,"\tint32_t x;\n");
	fprintf(hf,"\tint32_t y;\n");
	fprintf(hf,"\tint32_t w;\n");
	fprintf(hf,"\tint32_t h;\n");
...
void Generate_anchor_layer_output(FILE * sf, FILE * hf, Alps * anchor_layer,int postFIX){
    ...
    fprintf(sf,"\tanchor_layer_%d->confidence_thr = %d;\n",postFIX,FP2FIX(anchor_layer->confidence_thr,CONFIDENCE_Q));
...
//Fixed Point Version
void GenerateAnchorsLayer_FIXED(){
...
void GenerateAnchorsLayer(){
	...
	//Output Files Open
 	...
 	float n_aspect_ratios_1[]= {1., 2., 1./2., 1.3, 0.77};
 	float n_variances_1[]={0.1, 0.1, 0.2, 0.2}; //Compared to tflite with take reciprocal number to avoid divisions
 	anchors_layer_1->feature_map_width  = 20;
 	anchors_layer_1->feature_map_height = 15;
 	anchors_layer_1->n_classes  = 2;
 	anchors_layer_1->img_width  = 320;
 	anchors_layer_1->img_height = 240;
 	anchors_layer_1->this_scale = 0.08;
 	anchors_layer_1->next_scale = 0.14;
 	anchors_layer_1->anchor_params = 4;
 	anchors_layer_1->iou_thr = 0.1; //TODO CHeck this
	...
	//Output Files Open
 	...
 	float n_aspect_ratios_2[]= {1., 2., 1./2., 1.3, 0.77};
 	float n_variances_2[]={0.1, 0.1, 0.2, 0.2};
 	anchors_layer_2->feature_map_width  = 20;
 	anchors_layer_2->feature_map_height = 15;
 	anchors_layer_2->n_classes  = 2;
 	anchors_layer_2->img_width  = 320;
 	anchors_layer_2->img_height = 240;
 	anchors_layer_2->this_scale = 0.14;
 	anchors_layer_2->next_scale = 0.20;
	...
	float n_aspect_ratios_3[]= {1., 2., 1./2., 1.3, 0.77};
	...
	anchors_layer_3->img_width  = 320;
	anchors_layer_3->img_height = 240;
	anchors_layer_3->this_scale = 0.20;
	anchors_layer_3->next_scale = 0.28;
	...
	float n_aspect_ratios_4[]= {1., 2., 1./2., 1.3, 0.77};
	float n_variances_4[]={0.1, 0.1, 0.2, 0.2};
	anchors_layer_4->feature_map_width  = 20;
	anchors_layer_4->feature_map_height = 15;
	anchors_layer_4->n_classes  = 2;
	anchors_layer_4->img_width  = 320;
	anchors_layer_4->img_height = 240;
	anchors_layer_4->this_scale = 0.28;
	anchors_layer_4->next_scale = 1.;    //Tensorflow sources says is using 1 for latest scale
